...
# [Machine Learning: 시즌1](https://hunkim.github.io/ml/)
  ...
  - [x] Neural Network 1: XOR 문제와 학습방법, Backpropagation (1986 breakthrough)
    - [x] XOR 문제 딥러닝으로 풀기
    - [x] 특별편: 10분안에 미분 정리하기
    - [x] 딥넷트웍 학습 시키기 (backpropagation)
    - [x] 실습1: XOR을 위한 텐스플로우 딥넷트웍
    - [x] 실습2: Tensor Board로 딥네트웍 들여다보기
  - [x] Neural Network 2: ReLU and 초기값 정하기 (2006/2007 breakthrough)
    - [x] XSigmoid 보다 ReLU가 더 좋아
    - [x] Weight 초기화 잘해보자
    - [x] Dropout 과 앙상블
    - [x] 레고처럼 넷트웍 모듈을 마음껏 쌓아 보자
